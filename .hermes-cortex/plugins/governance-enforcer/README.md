...
ls ~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/
...
|-------|------|-----------|
| Moses | Orchestrator | `~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/` |
| Esther | Backup orchestrator | `~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/` |
| Gisu | Work staging | `~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/` |
| Kustos | Work production | `~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/` |
| Joseph | Personal production | `~/hermes-cortex/.hermes-cortex/plugins/governance-enforcer/` |
