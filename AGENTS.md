...
> Content relocated to [`docs/fleet-status-current.md`](docs/fleet-status-current.md) for focused reference.
> _Pruned by agents-doc-audit.py — the full content is preserved at the link above._
...
> Content relocated to [`docs/message-format.md`](docs/message-format.md) for focused reference.
> _Pruned by agents-doc-audit.py — the full content is preserved at the link above._
...
> Content relocated to [`docs/1-auto-remediation-pipeline.md`](docs/1-auto-remediation-pipeline.md) for focused reference.
> _Pruned by agents-doc-audit.py — the full content is preserved at the link above._
...
> Content relocated to [`docs/5-governance-quality.md`](docs/5-governance-quality.md) for focused reference.
> _Pruned by agents-doc-audit.py — the full content is preserved at the link above._
...
> Content relocated to [`docs/7-deployment-specific.md`](docs/7-deployment-specific.md) for focused reference.
> _Pruned by agents-doc-audit.py — the full content is preserved at the link above._
