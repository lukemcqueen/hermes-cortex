...
process_repo() {
  ...
  if [ -f AGENTS.md ]; then
    # Check if this is the rails-lukemcqueen-website variant (different template)
    if grep -q "AgentKore with OpenCode-native skills" AGENTS.md 2>/dev/null; then
      echo "  -> Using rails-lukemcqueen variant updates"
...
process_repo "/Users/luke/Developer/PERSONAL/lukemcqueen/rails-lukemcqueen-website" "main"
process_repo "/Users/luke/Developer/KOSCAP/koscap-av" "main"
process_repo "/Users/luke/Developer/KOSCAP/koscap-license" "main"

# koscap-live: git repo but NO remote
process_repo "/Users/luke/Developer/KOSCAP/koscap-live" "main"

# koscap-matching
process_repo "/Users/luke/Developer/KOSCAP/koscap-matching" "main"

# koscap-mwi: on feature/new-feature branch
process_repo "/Users/luke/Developer/KOSCAP/koscap-mwi" "feature/new-feature"
...
for repo in \
  ...
  /Users/luke/Developer/PERSONAL/lukemcqueen/nextjs-lukemcqueen-website \
  /Users/luke/Developer/PERSONAL/rgm/rgm-app; do
  name=$(basename "$repo")
  echo ""
  echo "--- $name ---"
  cd "$repo"
