...
| `docs/cron-schedules.md` | **Canonical cron schedule reference** — every cron, schedule, type, script, delivery (incl. explicit telegram targets for script-created crons, mycortex dream layer). Update whenever schedules change. |
