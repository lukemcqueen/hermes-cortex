...
| `docs/backup-orch-failover-runbook.md` | **Failover & recovery runbook** — step-by-step: Moses-down activation, drain, Moses-back reintegration. Auto-detection now via `orch-failover-watchdog` cron + `tests/test-failover-drill.py` |
