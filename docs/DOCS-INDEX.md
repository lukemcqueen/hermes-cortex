...
| `docs/templates/SOUL.md` | SOUL.md template — mandatory sections, governance sequence, inbox framework, behavioral principles (incl. Verify Before Reporting), scripture. Used by install.sh to seed new agents |
