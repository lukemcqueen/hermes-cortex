...
| `docs/design/mycortex-dream-todo-bridge.md` | **dream → todo bridge (proposal)** — requirements for turning dream output into actionable `bus.todos` items: Option A (monthly knowledge-gap → "learn X" todos, cap 4) + Option B (insight triage all tiers, cap 2), dedup + caps + tenant-scoping rules, orchestrator AC checklist. Added 2026-08-06 (Luke: "both would be useful") |
