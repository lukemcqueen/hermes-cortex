...
| `docs/templates/SOUL.md` | SOUL.md template (v3.0.0) — identity, mission, traits, 32 behavioral principles, patterns & pitfalls, scripture, final directive. Canonical source used by cortex-doctor.py for sync validation |
