...
| `auto-remediation-ecosystem` | 1.0.0 | (no description) | `skill_view(name='auto-remediation-ecosystem')` |
| `auto-remediation-setup` | 1.0.0 | (no description) | `skill_view(name='auto-remediation-setup')` |
| `bus-archive-diagnostics` | 1.0.0 | (no description) | `skill_view(name='bus-archive-diagnostics')` |
| `bus-client-resilience` | 1.0.0 | (no description) | `skill_view(name='bus-client-resilience')` |
| `bus-connectivity-diagnostics` | 1.0.0 | (no description) | `skill_view(name='bus-connectivity-diagnostics')` |
| `bus-inbox-check` | 1.0.0 | (no description) | `skill_view(name='bus-inbox-check')` |
| `bus-queue-maintenance` | 1.0.0 | (no description) | `skill_view(name='bus-queue-maintenance')` |
| `bus-send-auth-diagnostics` | 1.0.0 | (no description) | `skill_view(name='bus-send-auth-diagnostics')` |
...
| `cortex-bus-polling` | 1.0.0 | (no description) | `skill_view(name='cortex-bus-polling')` |
...
| `cron-output-contracts` | 1.0.0 | (no description) | `skill_view(name='cron-output-contracts')` |
| `cron-output-diagnostics` | 1.0.0 | (no description) | `skill_view(name='cron-output-diagnostics')` |
...
| `cron-script-naming-reconciliation` | 1.0.0 | (no description) | `skill_view(name='cron-script-naming-reconciliation')` |
| `cron-timezone-env` | 1.0.0 | (no description) | `skill_view(name='cron-timezone-env')` |
...
| `deployed-component-verification` | 1.0.0 | (no description) | `skill_view(name='deployed-component-verification')` |
...
| `docker-compose-bringup` | 1.0.0 | (no description) | `skill_view(name='docker-compose-bringup')` |
...
| `messaging-gateway` | 1.0.0 | (no description) | `skill_view(name='messaging-gateway')` |
...
| `nginx-security-pipeline` | 1.0.0 | (no description) | `skill_view(name='nginx-security-pipeline')` |
...
| `proactive-system-scan` | 1.0.0 | (no description) | `skill_view(name='proactive-system-scan')` |
...
| `tls-cert-preflight` | 1.0.0 | (no description) | `skill_view(name='tls-cert-preflight')` |
...
| `agent-contract` | 1.1.0 | Core execution contract: real work, honest results, verified outputs, minimal changes. | `skill_view(name='agent-contract')` |
...
| `agent-flow` | 1.2.0 | Workflow router skill — classifies the incoming request into one of 12 patterns and dispatches to the corre... | `skill_view(name='agent-flow')` |
...
| `survey-before-action` | 2.1.0 | Mandatory pre-flight checklist before creating or modifying any file. Prevents redundant work by systematic... | `skill_view(name='survey-before-action')` |
...
| `test-driven-development` | 1.2.0 | TDD: enforce RED-GREEN-REFACTOR, tests before code. | `skill_view(name='test-driven-development')` |
...
| Skill | Version | Purpose | Load With |
|-------|---------|---------|-----------|
| `task-start` | 1.3.0 | MANDATORY first action for every task. Bundles the complete pre-task sequence into one reference. Load this... | `skill_view(name='task-start')` |
