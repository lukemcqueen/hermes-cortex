...
**Script:** Save `hermes-cortex/ops/offline/auto-update.sh` to `~/.hermes/scripts/auto-update.sh`

**Setup:**

```bash
cp "${CORTEX_REPO:-$HOME/hermes-cortex}/ops/offline/auto-update.sh" ~/.hermes/scripts/auto-update.sh
