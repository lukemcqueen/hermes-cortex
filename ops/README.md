...
|| `services/` | Long-running services: dashboard, agent-inbox | Populated (dashboard, agent-inbox; a2a merged into agent-bus) |
| `offline/` | Offline knowledge stack: Kiwix, code corpus, gbrain sync | Populated (from `ops/offline/`) |
