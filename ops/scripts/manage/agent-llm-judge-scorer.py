...
Uses local Ollama model (default: qwen2.5:3b) for evaluation, posts scores to Langfuse API.
...
JUDGE_MODEL = get_model("JUDGE_MODEL", "qwen2.5:3b")

SCORE_CRITERIA = ["helpfulness", "clarity", "depth"]
MAX_TRACES_PER_RUN = 5  # ~3min on Intel with qwen2.5:3b
