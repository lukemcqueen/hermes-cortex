...
Generated by: `generate-inbox-wrappers.py` in `$CORTEX_REPO/ops/scripts/` (default: `~/hermes-cortex`)
...
3. Run: `python3 $CORTEX_REPO/ops/scripts/inbox/generate-inbox-wrappers.py --apply-crons`
...
```
`$CORTEX_REPO/ops/services/agent-inbox/`
