...
If you updated this skill (`cron-format-standard`) in the repo at `src/skills/devops/cron-format-standard/SKILL.md`:

```bash
cd ~/hermes-cortex
git add src/skills/devops/cron-format-standard/SKILL.md
